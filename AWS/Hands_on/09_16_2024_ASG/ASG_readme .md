...
```text
Security groups  : Remove Default SG and select ASGSecGroup
```
...
```text
Keep it as default (Volume 1 (AMI Root) (8 GiB, EBS, General purpose SSD (gp3)))
```
...
```text
Name: First-AS-Group
Launch template: MyTemplate_Auto_scaling
```
...
Existing load balancer target groups : MyTargetGroup
```
- Health Check
